# Boss Machine code academy

code academy cumulative practice for express server. i just added few routes and middleware in /api/... routes. All view and model done by code academy.
